...
contextBridge.exposeInMainWorld("studyJournalDesktop", Object.freeze({
  ...
  backup: Object.freeze({
    ...
    ensureRepository: (repositoryName) => ipcRenderer.invoke("study-journal:desktop-backup-ensure", repositoryName),
    listFiles: (repositoryName, directory) => ipcRenderer.invoke("study-journal:desktop-backup-list", repositoryName, directory),
    beginWrite: (repositoryName, path) => ipcRenderer.invoke("study-journal:desktop-backup-begin-write", repositoryName, path),
    ...
    readText: (repositoryName, path) => ipcRenderer.invoke("study-journal:desktop-backup-read-text", repositoryName, path),
    readChunk: (repositoryName, path, offset, length) => ipcRenderer.invoke("study-journal:desktop-backup-read-chunk", repositoryName, path, offset, length),
    deleteFile: (repositoryName, path) => ipcRenderer.invoke("study-journal:desktop-backup-delete", repositoryName, path),
  }),
  tts: Object.freeze({
